...
class ThreatArc(QWidget): 
    ...
    def showHideMetaDialog(self, showMetaDialog):
        ...
        if showMetaDialog:
            ...
            self.metaDialog.move(QPoint(self.reportedLocationOnCanvas.x(), self.reportedLocationOnCanvas.y()))
